...
use ProyectoFinal
go
CREATE PROCEDURE SP_Empleados_GetAll
AS
BEGIN
...
AS
BEGIN
	update Empleados set Nombre=@Nombre, Apellido=@Apellido, DNI=@DNI ,Genero=@Genero , PuestoDeTrabajo=@PuestoDeTrabajo, Peso=@Peso, Altura=@Altura, FechaNacimiento=@FechaNacimiento
	where DNI=@DNI
END
GO
...
insert into RulaTablaB values (5,6,2,8)
GO	
