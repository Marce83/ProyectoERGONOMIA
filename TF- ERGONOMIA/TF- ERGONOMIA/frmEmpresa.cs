...
namespace TF.WIN
{
    public partial class frmEmpresa : Form
    {
        ...
        private void dgvCargaEmpresas_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
                ...
                txtTelefono.Text = dgvCargaEmpresas.CurrentRow.Cells[5].Value.ToString();
                txtCorreo.Text = dgvCargaEmpresas.CurrentRow.Cells[6].Value.ToString();
                txtWeb.Text = dgvCargaEmpresas.CurrentRow.Cells[7].Value.ToString();
            }
